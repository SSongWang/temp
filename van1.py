# -*- coding: utf-8 -*-
"""
Created on Wed Feb 21 19:18:26 2024
...
def load_model_weights(model, arch, kwargs):
    url = model_urls[arch]
    checkpoint = torch.load('/home/swang/cross_view_transformers/van_pretrained_cityscapes.pth')#torch.hub.load_state_dict_from_url(
